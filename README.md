...
- **GCinema 브랜드 마크**: 레인보우 그라데이션(red-orange → green)을 적용한 로고 마크를 모든 화면 공통 헤더와 영화 목록·상세의 만족도·예매율 통계 줄에 일관되게 사용합니다. 이 통계 줄은 "만족도·예매율"과 "누적 관객수"를 두 줄로 나눠 표시해서, 마크가 있어도 좁은 카드 폭에서 글자가 잘리지 않습니다.
